<?php
/**
 * @package Winchester Template 1.7
 * @copyright Copyright 2003-2019 Zen Cart Development Team
 * @copyright Portions Copyright 2003 osCommerce
 * @license https://www.zen-cart-pro.at/license/3_0.txt GNU General Public License V3.0
 * @version $Id: init_winchester_responsive.php 2019-09-14 09:13:51Z webchills $
 */
...
$oldwinchester = $db->Execute("SELECT configuration_value FROM " . TABLE_CONFIGURATION . " WHERE configuration_key = '" . WINCHESTER_RESPONSIVE_VERSION . "';");
